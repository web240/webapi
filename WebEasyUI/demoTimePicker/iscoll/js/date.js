...
(function ($) {      
    $.fn.date = function (options, Ycallback, Ncallback) {
        ...
        $.fn.date.defaultOptions = {
            ...
            theme: "date",                    //控件样式（1：日期(date)，2：日期+时间(datetime)，3：时间(time)）
            mode: null,                       //操作模式（滑动模式）
        ...
        function addTimeStyle() {
            $("#datePage").css("position", "absolute");
            $("#datePage").css("height", "240px");
            $("#datePage").css("top", "60px");
            $("#Hourwrapper").css("position", "absolute");
            $("#Hourwrapper").css("top", "58px");
            $("#Hourwrapper").css("bottom", "68px");
            $("#Minutewrapper").css("position", "absolute");
            $("#Minutewrapper").css("top", "58px");
            $("#Minutewrapper").css("bottom", "68px");
            $("#Secondwrapper").css("position", "absolute");
            $("#Secondwrapper").css("top", "58px");
            $("#Secondwrapper").css("bottom", "68px");
        }
        //创建 --年-- 列表
